          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="text-left px-4 w-full max-w-4xl mx-auto">
              ...
              <p className="mb-6 text-gray-700 leading-relaxed">
                ...
                you use our website. By submitting your profile to <strong>publicbuilders.org</strong>, you agree to this Privacy Policy and consent to the public sharing of certain profile
                information as outlined below.
              </p>
              <h2 className="text-2xl font-semibold mb-4">Public Display of Information</h2>
              <p className="mb-6 text-gray-700 leading-relaxed">
                By submitting your profile to publicbuilders.org, you consent to having your profile information, including but not limited to your name, social media handles, and project details,
                publicly displayed on our website if approved. Please do not submit sensitive information that you do not wish to share publicly.
              </p>
              <h2 className="text-2xl font-semibold mb-4">Updating or Removing Public Information</h2>
              <p className="mb-6 text-gray-700 leading-relaxed">
                Updating or Removing Public Information You may request updates or removal of your publicly displayed profile information by{" "}
                <a href="https://github.com/johnnybuildsyo/publicbuilders/discussions">contacting us</a>. We will make reasonable efforts to honor these requests.
              </p>
